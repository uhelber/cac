...
public class ValidarTelefone implements Validator {
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        for (int i = 0; i < telefone.length(); i++) {
            ...
            if(!telefone.substring(i, i+1).equals("-") || !telefone.substring(i, i+1).equals("(") || !telefone.substring(i, i+1).equals(")")){
                FacesMessage mensagen = new FacesMessage(FacesMessage.SEVERITY_ERROR, "", "O campo " + campo + " não deve conter que não sejam \"()\" ou \"-\". Veja o ex.: (99)9999-9999");
