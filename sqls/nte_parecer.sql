...
CREATE TABLE `parecer` (
  ...
  KEY `fk_parecer_usuarios_idx` (`idparecer`),
  CONSTRAINT `fk_parecer_chamado` FOREIGN KEY (`chamado`) REFERENCES `chamado` (`idchamado`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_parecer_usuarios` FOREIGN KEY (`idparecer`) REFERENCES `usuarios` (`idusuarios`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2012-12-06 17:18:39
